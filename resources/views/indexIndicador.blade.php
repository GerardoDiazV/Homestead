...
@endsection
@section('content')
    <H1> <center> Administrar Indicadores </center></H1>
    <div class="container pb-5" style = "text-align: center; ">
    <a class="btn btn-secondary" href="{{route('indicador.create')}}" role="button"><font size="6">Registrar nueva actividad</font></a>
    </div>
    <div class = "container">

        <H2> <center> Indicadores Base: </center></H2>
        ...
        <H2> <center> Indicadores Nuevos: </center></H2>
    <table class="table table-bordered  table-striped table-hover" id="MyTable">
        <thead>
        <tr>
            <th class="text-center">ID</th>
                ...
                @if($item['meta_anual'] != null)
                    <tr>
                        ...
                        <td class="text-center" width="20%">
                            <div class = "btn-group">
                                <form action="{{route('indicador.destroy',$item->id)}}" method="POST">
                                    {{csrf_field()}}
                                <a class="btn btn-secondary" role="button"href="{{route('indicador.edit',$item->id)}}" >
                                    Editar
                                </a>
