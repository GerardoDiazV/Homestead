...
@section('content')
    ...
    <div class="container">
        <form autocomplete="off" method="POST" action="{{route('indicador.update',$indicador->id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="form-group row">
                <label for="inputNombre" class="col-sm-2 col-form-label">Nombre del Indicador</label>
                <div class="col-sm-3">
                    <input type="text" class="form-control" name= "nombre" id="inputNombre" value ="{{ $indicador['nombre'] }}">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputDescripcion" class="col-sm-2 col-form-label">Descripcion</label>
                <div class="col-sm-3">
                    <textarea class="form-control" name="descripcion" id="inputDescripcion" rows="3">{{ $indicador['descripcion'] }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" name= "formula" id="inputFormula" value ="{{ $indicador['formula'] }}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" name= "evidencia" id="inputEvidencia" value ="{{ $indicador['tipo_evidencia'] }}">
                </div>
            </div>
