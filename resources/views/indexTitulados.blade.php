@extends('UCN_layout')
@section('title')Administrar Registro Titulados DISC
@endsection
...
@endsection
@section('content')
    <H1> <center> Administrar Registro de Titulados DISC </center></H1>
    <div class="container pb-5" style = "text-align: center; ">
        <a class="btn btn-secondary" href="{{route('titulados.create')}}" role="button"><font size="6">Registrar nuevo alumno titulado</font></a>
    </div>
    <div class = "container">
        <table class="table table-bordered  table-striped table-hover" id="MyTable">
            ...
            @if($actividad_titulados)
                <ul>
                    @foreach($actividad_titulados as $item)
                        <tr>
                            ...
                            <td class="text-center" width="20%">
                                <div class = "btn-group">
                                    <form action="{{route('titulados.destroy',$item->id)}}" method="POST">
                                        {{csrf_field()}}
                                        <a class="btn btn-secondary" role="button"href="{{route('titulados.edit',$item->id)}}" >
                                            Editar
                                        </a>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ¿Esta seguro que desea eliminar titulado?
                                                    </div>
            ...
            @else
                <p> No hay alumnos registradas </p>
            @endif
        </table>
    </div>
